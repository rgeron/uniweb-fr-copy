...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-background dark:border-border bg-background shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
